...
. in the task table:
 ...
 [play] starts a simulation. Currently, only ¡®construction¡¯ of task type is implemented. ¡®demolish¡¯ has not been implemented
      Simulation takes account of ¡®end date¡¯ only   
